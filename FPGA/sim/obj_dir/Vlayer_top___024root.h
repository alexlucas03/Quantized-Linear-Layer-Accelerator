...
class alignas(VL_CACHE_LINE_BYTES) Vlayer_top___024root final : public VerilatedModule {
  public:
    ...
    VL_OUT8(busy,0,0);
    VL_OUT8(done,0,0);
    CData/*0:0*/ layer_top__DOT__tok_rd_en;
    CData/*0:0*/ layer_top__DOT__wgt_rd_en;
    CData/*0:0*/ layer_top__DOT__res_wr_en;
    CData/*1:0*/ layer_top__DOT__u_layer_ctrl__DOT__state;
    CData/*3:0*/ layer_top__DOT__u_layer_ctrl__DOT__vec_cnt;
    CData/*2:0*/ layer_top__DOT__u_layer_ctrl__DOT__neuron_cnt;
    CData/*3:0*/ layer_top__DOT__u_layer_ctrl__DOT__rd_addr_reg;
    CData/*2:0*/ layer_top__DOT__u_layer_ctrl__DOT__compute_pipe;
    ...
    SData/*15:0*/ __Vdly__layer_top__DOT__tok_rd_data;
    SData/*15:0*/ __Vdly__layer_top__DOT__wgt_rd_data;
    VL_OUT(result_rd_data,31,0);
    IData/*31:0*/ layer_top__DOT__res_wr_data;
